...
try {
    ...
    Invoke-PythonChecked -Python $Python -Stage "Manifest stage" -ArgumentList @(
        $Build,
    ...
    Invoke-PythonChecked -Python $Python -Stage "Rank training stage" -ArgumentList @(
        $Train,
    ...
    Invoke-PythonChecked -Python $Python -Stage "Overnight evaluate" -ArgumentList @(
        $Evaluate,
        "--manifest", "data\ranking\wangxing_v5_2\manifest.json",
