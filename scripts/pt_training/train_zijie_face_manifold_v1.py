"""Fit and evaluate the offline ZiJie face-and-mouth manifold checkpoint."""
...
from wangxing_project.zijie_face_manifold import (
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--train-cache",
        default="outputs/zijie/face_manifold_v1/cache/train_features.npz",
    )
    parser.add_argument(
        "--test-cache",
        default="outputs/zijie/face_manifold_v1/cache/test_features.npz",
    )
    parser.add_argument(
        "--profile",
    ...
    parser.add_argument(
        "--model",
        default="outputs/zijie/face_manifold_v1/models/zijie_face_manifold_v1.pt",
    )
    parser.add_argument(
        "--metrics",
    ...
    if manifest.get("subject") != "zijie":
        raise SystemExit("The ZiJie manifold manifest has the wrong subject.")
    profile = fit_zijie_face_manifold(
        manifest=manifest,
