...
def _prepare_negative(args: argparse.Namespace) -> Path:
    if args.negative_dataset == "RAVDESS":
        ...
        _run_step(
            ...
            [
                PYTHON,
                PROJECT_ROOT / "scripts/download_ravdess_negative.py",
                "--actors",
                args.ravdess_actors,
                "--source",
                args.ravdess_source,
    ...
    command: list[object] = [
        PYTHON,
        PROJECT_ROOT / "scripts/prepare_synthesized_metahuman_negative.py",
        "--output-root",
...
def run_pipeline(args: argparse.Namespace) -> dict[str, object]:
    ...
    _run_step(
        ...
        [
            PYTHON,
            PROJECT_ROOT / "scripts/extract_libreface_au.py",
            "--manifest",
            "data/video/expression_reference_manifest.json",
            "--output-root",
            "data/au/libreface",
            "--only-emotions",
            "--device",
    ...
    _run_step(
        ...
        [
            PYTHON,
            PROJECT_ROOT / "scripts/build_au_profile.py",
            "--manifest",
            "data/video/expression_reference_manifest.json",
            "--au-root",
            "data/au/libreface",
    ...
    _run_step(
        ...
        [
            PYTHON,
            PROJECT_ROOT / "scripts/fit_au_leakage_classifier.py",
            "--positive-root",
            "data/au/libreface",
            "--negative-root",
            "data/au/negative",
