...
def main(argv: list[str] | None = None) -> int:
    ...
    _run(
        ...
        [
            str(PYTHON),
            str(PROJECT_ROOT / "scripts/build_au_profile.py"),
            "--au-root",
            args.target_au_root,
            "--input-root",
            args.target_au_root,
    ...
    _run(
        ...
        [
            str(PYTHON),
            str(PROJECT_ROOT / "scripts/build_original_emotion_au_profile.py"),
            "--au-root",
    ...
    _run(
        ...
        [
            str(PYTHON),
            str(PROJECT_ROOT / "scripts/fit_au_leakage_classifier.py"),
            "--positive-root",
            args.target_au_root,
            "--negative-root",
