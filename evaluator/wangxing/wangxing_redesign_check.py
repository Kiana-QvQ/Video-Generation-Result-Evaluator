...
def inspect_wangxing_redesign(
    ...
    ) or (root / "data/au/wangxing_identity_profile.json")
    expression_path = resolve_profile(
        "wangxing_expression_profile.json",
        "data/au/wangxing_expression_profile.json",
    ) or (root / "data/au/wangxing_expression_profile.json")
    source_path = resolve_profile(
        "wangxing_source_profile.json",
        "data/au/wangxing_source_profile.json",
    ) or (root / "data/au/wangxing_source_profile.json")
    ...
    forensic_path = resolve_profile(
        "forensics_profiles.json",
        "outputs/forensics/forensics_profiles.json",
    ) or (root / "outputs/forensics/forensics_profiles.json")
